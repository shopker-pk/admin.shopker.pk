                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal form-bordered" action="{{ route('update_products', $query_product->id) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <h4 class="form-section">Edit Product</h4>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="label-control">Product Vendor</label><label class="label-control" style="color:red">*</label>
                                                        <select id="vendor" name="vendor" class="form-control select_2" style="width: 100%">
                                                            @if(!empty($vendors))
                                                                <option value="00">No Vendor selected</option>
                                                                @foreach($vendors as $row)
                                                                    <option value="{{ $row->id }}" @if(old('vendor', $query_product->user_id) == $row->id) selected @endif>{{ $row->first_name.' '.$row->last_name }}</option>
                                                                @endforeach
                                                            @else
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                @if(!empty($query_product->to_date))
                                                                                    <input type="text" id="to" name="to" class="form-control advertise_datepicker" value="{{ old('to', date('d-M-Y', strtotime($query_product->to_date))) }}" style="width: 100%;height: 38px;">
                                                                                @else
                                                                                    <input type="text" id="to" name="to" class="form-control advertise_datepicker" value="{{ old('to') }}" style="width: 100%;height: 38px;">
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    </div>
