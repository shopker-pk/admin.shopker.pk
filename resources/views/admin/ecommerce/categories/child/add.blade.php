                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" action="{{ route('insert_child_categories') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <h4 class="form-section">Add Child Category</h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <select id="parent_category" name="parent_category" class="form-control select_2">
                                                        <option>No parent cateogry</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <input type="text" id="sorting_order" name="sorting_order" class="form-control" placeholder="Sorting Order" value="{{ old('sorting_order') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row last">
