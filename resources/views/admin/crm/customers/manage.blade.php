                                                ...
                                                @if(!empty($query))
                                                    @foreach($query as $row)
        			                                    <tr>
        				                                    ...
        				                                    <td>
                                                                <label class="switch">
                                                                    <a href="{{ url('/user/admin/crm/customers/update-status/'.$row->id.'/'.$row->status) }}">
        				                                    ...
        				                                    <td>
        				                                    	<div role="group" class="btn-group">
        														    ...
        														    <div aria-labelledby="btnGroupDrop1" class="dropdown-menu">
                                                                        <a href="javascript::void(0);" class="dropdown-item" data-toggle="modal" data-target="#customer_status_{{ $row->id }}">Edit Status</a>
        														    	<a href="javascript::void(0);" class="dropdown-item" data-toggle="modal" data-target="#customer_details_{{ $row->id }}">View Details</a>
        														    </div>
        														</div>
        													</td>
        				                               	</tr>
